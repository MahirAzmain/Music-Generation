...
Original file is located at
    https://colab.research.google.com/drive/1xJee6CwCSPKR_8f66-9nN1LtLdfrZQ9y
"""

!pip install comet_ml > /dev/null 2>&1
import comet_ml

COMET_API_KEY = "ZThYCqBDMl2uKCUtAikJUP4P7"
...
def generate_text(model, start_string, generation_length=1000):
  ...
  # Here batch size == 1
  # model.reset_states() # This is causing the error
  # Iterate through layers and reset stateful layers
